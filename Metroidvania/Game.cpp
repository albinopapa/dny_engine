...
Game::Game( dny::Rect<std::int32_t> const& viewport, dny::LevelDocument& document_ )
	: m_viewport( viewport ), m_document( document_ ){}
...
void Game::render( dny::renderer2d& renderer_, dny::Font const& font_ ) const{
	...
	renderer_.draw_text( "Game State", { 10.f, 10.f }, font_, dny::Colors::white );
	renderer_.draw_text( "Not yet implemented: Press Escape to return to menu", { 10.f, 30.f }, font_, dny::Colors::white );
}
